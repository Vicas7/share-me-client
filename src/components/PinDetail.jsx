      ...
      <div className='flex xl:flex-row flex-col m-auto bg-white' style={{ maxWidth: '1500px', borderRadius: '32px' }}>
        <div className='flex justify-center items-center md:items-start flex-initial'>
          <img
            ...
            className='rounded-t-3xl rounded-b-lg max-h-[650px]'
            alt='user-post'
          />
        </div>
        <div className='w-full p-5 flex-1 xl:min-w-620'>
          ...
          <Link to={`/user-profile/${pinDetail.postedBy?._id}`} className='flex gap-2 mt-5 items-center bg-white rounded-lg'>
            <img src={pinDetail.postedBy?.image} alt='user-profile' className='w-6 h-6 rounded-full object-cover' />
          ...
          <div className='flex flex-wrap mt-6 gap-3'>
            <Link to={`/user-profile/${pinDetail.postedBy?._id}`} className='flex items-center'>
              <img src={pinDetail.postedBy?.image} alt='user-profile' className='w-8 h-8 rounded-full cursor-pointer' />
            </Link>
            <form className='flex flex-wrap gap-3 flex-1' onSubmit={addComment}>
              <input
                type='text'
              ...
              />
              <button type='submit' className='bg-red-500 text-white rounded-full px-6 py-2 font-semibold text-base outline-none'>
